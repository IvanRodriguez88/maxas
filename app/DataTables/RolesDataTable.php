...
class RolesDataTable extends DataTable
{
    ...
    public function getActions($row){
        ...
        if (auth()->user()->hasPermissions("roles.edit")) {
            $result .= '
                <a title="Editar" href='.route("roles.edit", $row->id).' class="btn btn-outline-secondary btn-icon ps-2 px-1">
        ...
        if (auth()->user()->hasPermissions("roles.destroy")) {
            $result .= '
        ...
        if (auth()->user()->hasPermissions("roles.show")) {
            $result .= '
                <a title="Permisos" href='.route("roles.show", $row->id).' class="btn btn-outline-dark btn-icon ps-2 px-1">
    ...
    public function getColumns(): array
    {
        ...
        if (auth()->user()->hasPermissions("roles.edit") ||
            auth()->user()->hasPermissions("roles.create") ||
            auth()->user()->hasPermissions("roles.destroy")) {
